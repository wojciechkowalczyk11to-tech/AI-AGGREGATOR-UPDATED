...
class ChatService(BaseService):
    async def send_message(self, user_id: str, token: str, prompt: str, conversation_id: str | None = None, use_rag: bool = False) -> dict:
    ...
    async def send_with_provider(self, user_id: str, token: str, prompt: str, provider: str, conversation_id: str | None = None) -> dict:
